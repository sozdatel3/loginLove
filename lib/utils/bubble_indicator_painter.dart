...
import 'package:loginLove/theme.dart';
...
class BubbleIndicatorPainter extends CustomPainter {
  ...
  final double radius;
  final double dy;
  final PageController pageController; // Made non-nullable
  final Paint painter;
  ...
  BubbleIndicatorPainter({
    ...
    this.radius = 21.0,
    this.dy = 25.0,
    required this.pageController, // Added required keyword
  })  : painter = Paint()
  ...
  bool shouldRepaint(BubbleIndicatorPainter oldDelegate) =>
      dxTarget != oldDelegate.dxTarget ||
      dxEntry != oldDelegate.dxEntry ||
      radius != oldDelegate.radius ||
      dy != oldDelegate.dy ||
      pageController != oldDelegate.pageController;
}
